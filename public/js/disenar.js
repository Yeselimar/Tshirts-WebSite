...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_pages_disenar_disenarComponent_vue__ = __webpack_require__(155);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_swatches__ = __webpack_require__(157);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_draggable_resizable__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_draggable_resizable_dist_VueDraggableResizable_css__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_vue_swatches_dist_vue_swatches_min_css__ = __webpack_require__(158);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        showProductsPanel: function showProductsPanel(activo) {
        ...
        showImagePanel: function showImagePanel(activo) {
            if (this.showImage) {
        ...
        showInfoPanel: function showInfoPanel(activo) {
            if (this.showInfo) {
        ...
        [
            ...
            _c(
              ...
              [
                _c(
                  "div",
                  {
                    staticClass: "panel-btn d-flex",
                    class: [
                      {
                        "panel-btn-active pulse animated":
                          _vm.activo === "Productos"
                      }
                    ],
                    on: {
                      click: function($event) {
                        $event.stopPropagation()
                        $event.preventDefault()
                        return _vm.showProductsPanel("Productos")
                      }
                    }
                  },
                  [
                  ...
                  "div",
                  {
                    ...
                    on: {
                      click: function($event) {
                        $event.stopPropagation()
                        $event.preventDefault()
                        return _vm.showImagePanel("Imagen")
                      }
                    }
                  },
                  [
                ...
                _c(
                  "div",
                  {
                    ...
                    class: [
                      {
                        "panel-btn-active pulse animated": _vm.activo === "Info"
                      }
                    ],
                    on: {
                      click: function($event) {
          ...
          _c("div", { staticClass: "panel-diseno-l2 justify-content-center" }, [
            ...
            _c(
              "div",
              {
                staticClass: "container-imagen-a-disenar",
                attrs: { id: "content" }
              },
              [
                _c("img", {
                  attrs: { src: "http://localhost:8000/img/product/remera.png" }
                }),
                _vm._v(" "),
                _c(
                  "div",
                  { staticClass: "container-area-de-diseno" },
                  [
                    _c(
                      "vue-draggable-resizable",
                      {
                        attrs: {
                          ...
                          h: 50,
                          resizable: true,
                          parent: ".container-area-de-diseno"
                        }
                      },
                      [_c("p", [_vm._v("Hola")])]
                    )
    ...
    return _c("div", { staticClass: "productos-disenar" }, [
      _c("div", { staticClass: "product-item" }, [
        _c("div", { staticClass: "pi-pic" }, [
          _c("img", {
            attrs: { src: "http://localhost:8000/img/product/12.jpg", alt: "" }
          })
        ]),
        _vm._v(" "),
